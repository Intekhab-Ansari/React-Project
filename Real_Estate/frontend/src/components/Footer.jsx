  ...
  return (
    ...
    id='Footer'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          ...
          <p className='text-gray-400 mt-4'>
            ...
            Molestiae voluptatum exercitationem reiciendis molestias, 
            sed qui labore dignissimos deserunt accusamus, saepe cupiditate 
            libero quibusdam assumenda consequuntur, commodi doloremque. 
            Consectetur, nostrum illum!</p>
        </div>
      ...
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
        Copyright 2025 © Intekhab. All Right Reserved.
      </div>
    </div>
  )
}
